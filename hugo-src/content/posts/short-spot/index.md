...
The site no longer runs the Short Spot podcast services. I removed the live manager, stripper, podcast storage, and deploy notes from this site, but the article stays here as the record of the experiment.
...
The software, hosted on GitHub ([https://github.com/rhew/short-spot](https://github.com/rhew/short-spot)), uses AI to:
